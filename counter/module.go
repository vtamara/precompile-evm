...
var ContractAddress = common.HexToAddress("0x0300000000000000000000000000000000000016") // SET A SUITABLE HEX ADDRESS HERE
...
func (*configurator) Configure(chainConfig precompileconfig.ChainConfig, cfg precompileconfig.Config, state contract.StateDB, blockContext contract.ConfigurationBlockContext) error {
	...
	i := big.NewInt(0)
	i.SetString(config.DefaultCounter, 16)
	StoreCounterValue(state, i)
	return nil
}
